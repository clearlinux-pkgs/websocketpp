...
Version  : 0.8.2
Release  : 1
URL      : https://github.com/zaphoyd/websocketpp/archive/0.8.2/websocketpp-0.8.2.tar.gz
Source0  : https://github.com/zaphoyd/websocketpp/archive/0.8.2/websocketpp-0.8.2.tar.gz
...
%package dev
Summary: dev components for the websocketpp package.
Group: Development
Provides: websocketpp-devel = %{version}-%{release}
Requires: websocketpp = %{version}-%{release}

%description dev
dev components for the websocketpp package.


%prep
%setup -q -n websocketpp-0.8.2
cd %{_builddir}/websocketpp-0.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685659254
mkdir -p clr-build
pushd clr-build
